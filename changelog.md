...
- Added a GM random-table roller: every Cairn and Monolith table read from the system books, type-ahead table selection, a switcher between systems and custom Markdown table sets, and public, private, invisible, or revealed rolls.
